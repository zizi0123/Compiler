...
import static util.type.ConstType.*;
...
public class Type {
    ...
    public Type(String baseTypeName, Position pos) {
    ...
    public boolean equals(Type a, Scope scope) {
        if (!scope.isInClass) {
    ...
    public boolean equalsNull(Type a, Scope scope){
