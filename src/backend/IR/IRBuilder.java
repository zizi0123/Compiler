...
import backend.IR.instruction.arithmetic.*;
import backend.IR.instruction.icmp.*;
import backend.IR.Entity.literal.*;
import backend.IR.type.IRClassType;
...
import frontend.ast.util.constValue.*;

import java.io.File;
import java.io.PrintWriter;
import java.util.ArrayList;

import static backend.IR.Entity.literal.Literal.defaultVal;
import static backend.IR.type.IRType.toIRType;
import static backend.IR.type.IRTypes.*;
import static frontend.ast.util.scope.GlobalScope.*;
...
public class IRBuilder implements ASTVisitor {
    ...
    backend.IR.IRFunction currentFunction;
